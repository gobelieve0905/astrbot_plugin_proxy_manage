...
class TestConfigurationRules(unittest.TestCase):
    ...
    def test_management_page_has_responsive_navigation_and_stable_controls(self):
        ...
        self.assertIn('流量控制 · 0.3.20',html)
        ...
        self.assertIn('data-template-use',script)
        self.assertIn("openRuleDialog('',button.dataset.template)",script)
        self.assertIn("if(returnTab==='platforms')tab='routes'",script)
